...
class MetaDataLogging:
    #instantiate an object with current pipeline name and the logging database client
    def __init__(
        self,
        pipeline_name: str,
    ...
    #added create_all_tables method to the PostgresSqlClient class
    ...
    #records pipeline metadata log to logging database
    def log(
        self,
